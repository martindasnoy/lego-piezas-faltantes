/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareEnv ./cloudflare-env.d.ts` (hash: aa8c2c35ba3ff8d5ade1b5cdf32e59a0)
// Runtime types generated with workerd@1.20260302.0 2026-02-24 global_fetch_strictly_public,nodejs_compat
declare namespace Cloudflare {
	interface Env {
		IMAGES: ImagesBinding;
		ASSETS: Fetcher;
		NEXTJS_ENV: string;
		WORKER_SELF_REFERENCE: Fetcher /* lego-piezas-faltantes */;
	}
}
